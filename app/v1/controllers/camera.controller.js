...
var MachineRepo = db_1.AppDataSource.getRepository(Machine_1.Machine);
var CameraController = /** @class */ (function () {
    function CameraController() {
    }
    CameraController.prototype.create = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var machine, missingParameters, camera, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 6, , 7]);
                        console.log(req.body);
                        return [4 /*yield*/, MachineRepo.findOneBy({ id: req.body.machine })];
                    case 1:
                        machine = _a.sent();
                        req.body.machine = machine;
                        missingParameters = Camera_1.Camera.isMissing(req.body);
                    ...
                    case 2:
                        camera = _a.sent();
                        if (!!camera) return [3 /*break*/, 5];
                        return [4 /*yield*/, CameraRepo.create(req.body)];
                    case 3:
                        camera = _a.sent();
                        camera.machine = machine.id;
                        return [4 /*yield*/, CameraRepo.save(camera)];
                    case 4:
                        _a.sent();
                        _a.label = 5;
                    case 5:
                        console.log(camera);
                        return [2 /*return*/, res.status(200).json(camera)];
                    case 6:
                        error_1 = _a.sent();
    ...
    CameraController.prototype.list = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var cameras, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, CameraRepo.find({})];
                    case 1:
                        cameras = _a.sent();
                        return [2 /*return*/, res.status(200).json(cameras)];
                    case 2:
                        error_2 = _a.sent();
    ...
    CameraController.prototype.update = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, CameraRepo.save(req.body)];
                    case 1:
                        _a.sent();
