...
if (process.env.PROTOCOL === 'https') {
    ...
    var serverOptions = {
        key: fs_1.default.readFileSync(path_1.default.join(__dirname, '../heleo.key')),
        cert: fs_1.default.readFileSync(path_1.default.join(__dirname, '../ffad2677a2e232ba.pem')),
        ca: fs_1.default.readFileSync(path_1.default.join(__dirname, '../heleo.csr'))
    };
